...
Un **buffer ideale** ha transizione verticale sul punto medio $V_{DD}/2$; un buffer reale ha una pendenza finita.
Convenzionalmente si scelgono $V_{IL}$ e $V_{IH}$ nei punti in cui la pendenza vale $-1$, perché è lì che il guadagno del circuito cessa di attenuare il rumore.
