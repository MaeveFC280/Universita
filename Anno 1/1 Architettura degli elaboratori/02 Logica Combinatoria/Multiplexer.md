...
Realizzazioni possibili: [[Da equazioni a schemi - logica a due livelli|logica multilivello]] ([[Forme canoniche SOP e POS|SOP]]), oppure con **buffer three-state**
...
Si costruisce sia in [[Da equazioni a schemi - logica a due livelli|logica multilivello]], sia come **albero** di mux 2:1 (gerarchia e modularità: soluzione più regolare e più economica).
