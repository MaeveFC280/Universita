...
## Perché avviene
Perché i vari cammini attraverso il circuito hanno **[[Timing combinatorio - ritardo di propagazione e cammino critico|ritardi diversi]]**. Se il cambio di una variabile "spegne" un implicante prima che ne "accenda" un altro, l'uscita passa momentaneamente per un valore sbagliato.

## Come si riconoscono sulla K-map
> Un glitch può verificarsi quando il cambio di **una sola variabile** attraversa il
> confine tra **due cerchi diversi** della[[Mappe di Karnaugh|mappa di Karnaugh]].
...
## Come si eliminano
Aggiungendo un implicante **ridondante** che "copre a cavallo" del confine tra i due cerchi, così che nessuna transizione singola scavalchi un confine scoperto.
