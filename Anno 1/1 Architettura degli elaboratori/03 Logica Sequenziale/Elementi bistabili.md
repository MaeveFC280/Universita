...
- **Caso I: $Q = 0$** $\overline{Q}$ vale 1, che riportato in ingresso a $I_1$ produce 0 su $Q$. Coerente con l'ipotesi iniziale → lo stato è **stabile**.
- **Caso II: $Q = 1$** $\overline{Q}$ vale 0, che riportato in ingresso produce 1 su $Q$. Anche questo è coerente → **stabile**.
