...
### L'istruzione MOV
L'istruzione **`MOV`** (move) è il modo tipico di **inizializzare** il valore di un registro:
```
MOV R0, #17         ; R0 = 17
MOV R2, R3          ; R2 = R3
...
Il campo immediato nelle istruzioni di elaborazione dati è di **12 bit**, ma non codifica un numero da 0 a 4095: è diviso in
